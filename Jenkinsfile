   ...
   stages {
       ...
       stage('build') {
        steps {
            ...
            sh 'curl -X POST -H "Content-Type: application/json" -d "{\"chat_id\": \"-607571432\", \"text\": \"Jenkins says hi\"}" https://api.telegram.org/bot5736407974:AAF_mvzzO7jjzaNYgxn2inImUX7Rg0f0VZ4/sendMessage'
        }
       }
       stage('Conditional') {
            steps {
